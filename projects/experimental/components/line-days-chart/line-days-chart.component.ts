...
import {
    TuiLineChart,
    TuiLineChartHint,
} from '@taiga-ui/experimental/components/line-chart';
...
@Component({
    ...
    imports: [NgForOf, PolymorpheusOutlet, TuiLineChart, TuiLineChartHint],
...
export class TuiLineDaysChart {
    ...
    protected get months(): Array<Array<readonly TuiPoint[]>> {
            ...
            .map((month, index, array) =>
                index === array.length - 1
                    ...
                    : [
                          [
                              ...month,
                              array[index + 1]?.find((day) => !Number.isNaN(day[1])) ||
                                  DUMMY,
                          ],
                      ],
            );
